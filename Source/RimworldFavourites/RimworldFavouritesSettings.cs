...
namespace RimworldFavourites
{
    public class RimworldFavouritesSettings : ModSettings
    {
        ...
        public QualityRange autoFavouriteProductQualityRange = new QualityRange(QualityCategory.Masterwork, QualityCategory.Legendary);
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref autoFavouriteProductQualityRange, "autoFavouriteManufacturedQualityRange", new QualityRange(QualityCategory.Masterwork, QualityCategory.Legendary));
